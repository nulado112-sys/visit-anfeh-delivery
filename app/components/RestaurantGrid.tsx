            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: restaurant.logo_fit === "contain" ? "#ffffff" : "#EBF8FA" }}
                >
                  {restaurant.logo ? (
                    <LogoImage
                      ...
                      className={`transition-transform duration-500 group-hover:scale-105 ${restaurant.logo_fit === "contain" ? "object-contain p-4" : "object-cover"}`}
                    />
                  ) : (
